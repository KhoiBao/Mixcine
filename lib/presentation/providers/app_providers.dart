...
// ---------------------------------------------------------------------------
// Theme Mode – quản lý trạng thái Light / Dark và lưu vào SharedPreferences.
// ---------------------------------------------------------------------------

/// Notifier quản lý ThemeMode.
/// - Đọc giá trị đã lưu khi khởi tạo (build).
/// - Cung cấp [toggle] để chuyển đổi và lưu trạng thái mới.
class ThemeModeNotifier extends AsyncNotifier<ThemeMode> {
  ...
  /// Chuyển đổi giữa Light và Dark, đồng thời lưu lại.
  Future<void> toggle() async {
    final prefs = ref.read(appPreferencesProvider);

    // Xác định mode mới (ngược lại mode hiện tại)
...
/// Provider toàn cục cho ThemeMode.
